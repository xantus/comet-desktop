...
(function() {
    ...
    Ext.lib.Ajax.Queue = function(config) {
        ...
        Ext.apply(this, config, {
            ...
            // false implies LIFO
            callback: null,
            // optional callback when queue is emptied
            scope: null,
            // scope of callback
            suspended: false,
    ...
    Ext.lib.Ajax.QueueManager = function(config) {
        ...
        Ext.apply(this, config || {}, {
            quantas: 10,
            // adjustable milliseconds deferred dispatch
            // value
            priorityQueues: new Array(new Array(), new Array(), new Array(), new Array(), new Array(), new Array(), new Array(), new Array(), new Array(), new Array()),
            // iterable
            // array
            // (0-9)
            // of
    ...
    Ext.apply(A, {
        ...
        monitoredNode: function(tag, attributes, callback, context, deferred) {
            ...
            if (tag && doc && head) {
                ...
                ndom && forEach(attributes || {},
                function(value, attrib) {
                    ...
                    if (!element.disabled && name) {
                        if (reSelect.test(type)) {
                            forEach(element.options, function(opt) {
                                if (opt.selected) {
                                    data += String.format("{0}={1}&", encoder(name), encoder(
        ...
        getHttpStatus: function(reqObj, isAbort, isTimeout) {
            ...
            } catch(e) {} // status may not avail/valid yet, called too early, or status not support by the transport
        ...
        handleTransactionResponse: function(o, callback, isAbort, isTimeout) {
             ...
             */
            o.status.isError && (responseObject = Ext.apply({},
            responseObject || {},
        ...
        createResponseObject: function(o, callbackArg, isAbort, isTimeout) {
            ...
            if (isAbort !== true) {
                ...
                try {
                    ...
                    var s;
                    headerStr.split('\n').forEach(function(sHeader) { (s = sHeader.split(':')) && s.first() && (headerObj[s.first().trim().toLowerCase()] = (s.last() || '').trim());
                    });
        ...
        makeRequest: function(method, uri, callback, postData, options) {
            ...
            if (o = this.getConnectionObject(uri, options, postData)) {
                ...
                try {
                    ...
                    if (callback && callback.timeout) { ('timeout' in r) && (r.timeout = callback.timeout);
        ...
        abort: function(o, callback, isTimeout) {
            ...
            if (o && o.queued && o.request) {
                ...
                if (!this.events || this.fireEvent(isTimeout ? 'timeout': 'abort', o, callback) !== false) { ('abort' in o.conn) && o.conn.abort();
        ...
        // private
        initHeader: function(label, value) { (this.headers = this.headers || {})[label] = value;
        },
        ...
        onStateChange: function(o, callback, mode) {
            ...
            var C = o.conn,
            readyState = ('readyState' in C ? C.readyState: 0);
    ...
    Ext.applyIf(Array.prototype, {
        ...
        compact: function(deep) { // Remove null, undefined array
            // elements
            var a = new Array();
            this.forEach(function(v) { (v === null || v === undefined) || a.push(deep && Ext.isArray(v) ? v.compact() : v);
            },
            this);
            return a;
        },
    ...
    Ext.applyIf(Array, {
        ...
        forEach: function(collection, block, scope) {
            ...
            for (var i = 0, l = collection.length >>> 0; i < l; ++i) { (i in collection) && block.call(scope || null, collection[i], i, collection);
            }
        }
    });
...
The testCodec function permits selective codec support testing:
        ...
        hasVideo: function() {
            ...
            codecs = {
                ...
                //mp4 (Apple: patented licensed codec)
...
Ext.applyIf(Function.prototype, {
    forEach: function(object, block, context, protos) {
        if (object) {
            var key;
            for (key in object) { ( !! protos || object.hasOwnProperty(key)) && block.call(context || object, object[key], key, object);
            }
        }
    },
...
(function() {
    ...
    Ext.apply(Task.prototype, {
        ...
        doCallBacks: function(options, success, currModule, args) {
            ...
            if (C = currModule) {
                var res = this.MM.fireEvent.apply(this.MM, [(success ? 'load': 'loadexception'), this.MM, C].concat(args || []));
                ...
                if (moduleObj = this.MM.createModule(module.module, {
                    ...
                    if ((!moduleObj.loaded) || options.forced) {
                        ...
                        if (!moduleObj.pending) {
                            ...
                            transport = gather(
                            options.method == 'DOM' ? (moduleObj.extension == 'css' ? 'LINK': 'SCRIPT') : options.method, url, {
    ...
    var L = Ext.Loader = new Ext.ux.ModuleManager({
        ...
        modulePath: '',
        //adjust for site root
        method: 'DOM',
        depends: {},
        // Ext dependency table
        disableCaching: true,

        getMap: function(module) {

            var result = new Array(),
            mods = new Array().concat(module.module || module);
 ...
 $JIT.onClassAvailable(['Ext.ux.grid.RowEditor','Ext.ux.ManagedIFrame'],classesAreHereFn);
    ...
    */
    ...
    load_options = {
        async: false,
        method: 'GET',
        callback: function(completed) { ! completed && L.fireEvent('loadexception', L, this.currentModule, "Ext.ComponentMgr:$JIT Load Failure");
        },
        scope: L
    },
    assert = function(rm) {
        return !! rm && typeof rm == 'object' ? Ext.apply({},
        load_options, rm) : rm;
    };

...
CometDesktop.ux.IRCExample = Ext.extend( CometDesktop.Module, {

    id: 'ircexample-win',
    title: 'IRC Client',

    requires: [
        'lib/Sprocket/Filter.js',
        'lib/Sprocket/Filter/Line.js',
        'lib/Sprocket/Filter/IRC.js',
        '/apps/irc-example/css/irc.css'
    ],
    ...
    create: function() {
        return app.createWindow({
            xtype: 'irc-client',
            wsUrl: app.websocketUrl( '/irc-websocket' ),
            id: this.id,
            title: this.title,
            width: 600,
            height: 300,
...
new CometDesktop.ux.IRCExample();

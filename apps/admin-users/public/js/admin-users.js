...
// Grid for grouping and managing the User groups and their properties
CometDesktop.ux.admin.GroupAdminGrid = Ext.extend(Ext.grid.EditorGridPanel, {
    ...
    initComponent : function() {
        Ext.apply(this, {
            ...
            store: {
                xtype: 'managestore',
                url:  '/desktop/apps/admin-users/api/grouping',
                root: 'data',
...
CometDesktop.ux.admin.UserAdminGrid = Ext.extend(Ext.grid.EditorGridPanel, {
    ...
    initComponent : function() {
        Ext.apply(this, {
            ...
            store: {
                xtype: 'managestore',
                url:  '/desktop/apps/admin-users/api/users',
                root: 'data',
                //fields: [ 'vch_user_name','vch_email','fk_roles_iroleid'],
                fields: [ 'vch_user_name','vch_email'],
                baseParams: {
                    test: 'test'
                },
                autoLoad: true
    ...
    initComponent : function() {
        Ext.apply(this, {
            ...
            store: {
                ...
                root: 'data',
                url:  '/desktop/apps/admin-users/api/groups',
                reader: new Ext.data.JsonReader({
                    root: 'data',
